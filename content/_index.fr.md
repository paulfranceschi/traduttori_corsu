...
La [version pour windows de Traduttori corsu](/zip/traduttore-corsu.zip) peut être téléchargée. Il s'agit d'un fichier zip, qui doit être décompacté. Il suffit ensuite de lancer le fichier traduttori-corsu.exe.
