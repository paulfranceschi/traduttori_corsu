...
La performance de l'application Traduttore corsu  est évaluée régulièrement à l’aide d’un test ouvert qui consiste en la traduction d’un texte pseudo-aléatoire. Ce test porte sur la traduction des 100 premiers mots de l’ « article labellisé du jour » de l’encyclopédie wikipédia en français. Actuellement, le logiciel obtient en moyenne 94 % à ce test.

À la différence des logiciels de traduction automatique basés sur les statistiques ou des corpus de traduction, Traduttore corsu se fonde sur l’application des règles (grammaire, désambiguïsation, élision, euphonie, etc.). Ce choix correspond à plusieurs motivations :
...
La version libre permet de traduire des textes d'une longueur de 500 mots. La version professionnelle permet la traduciton de textes sans limitation de longueur.
