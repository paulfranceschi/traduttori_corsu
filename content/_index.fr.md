...
La version pour windows de Traduttori corsu peut être téléchargée: [traduttorecorsu.zip](/zip/traduttore-corsu.zip). Il s'agit d'un fichier zip, qui doit être décompacté. Il suffit ensuite de lancer le fichier traduttori-corsu.exe.
